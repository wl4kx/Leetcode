...
public class BulbSwitcher {
	...
	public static void main(String[] args) {
		...
		System.out.println("result is " + instance.bulbSwitch(9999999));
		...
		for (int i = 1; i <= n; i++) {
			...
			while(count<=n){
				if(statusArray[count-1]){
					statusArray[count-1]=false;
					//ret++;
				}else{
					statusArray[count-1]=true;
					//ret--;
				}
				count += i;
			}
	...
	// explaination from https://leetcode.com/discuss/77125/crystal-clear-explanation-one-line-c-code
	/*
